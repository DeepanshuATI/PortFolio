      ...
      <div className="max-w-5xl mx-auto relative z-10" ref={ref}>
        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-16">
          <form
            ...
            className="lg:col-span-3 glass p-8 sm:p-12 rounded-2xl space-y-8"
            id="contact-form"
          >
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            {/* Contact info card */}
            <div className="glass p-8 sm:p-10 rounded-2xl space-y-6">
            ...
            <div className="glass p-8 sm:p-10 rounded-2xl flex-grow flex flex-col items-center justify-center text-center relative overflow-hidden group">
              <div
